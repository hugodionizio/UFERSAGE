...
char *type_names[] = { "invalid", "char", "short", "int", "uchar", "ushort",
		"uint", "float", "double", };
...
PlyFile *ply_open_for_writing(char *filename, int nelems, char **elem_names,
...
void ply_describe_element(PlyFile *plyfile, char *elem_name, int nelems,
...
void ply_describe_property(PlyFile *plyfile, char *elem_name,
	...
	if (elem->nprops == 0) {
		...
		elem->store_prop = (char *) realloc(elem->store_prop,
				sizeof(char) * elem->nprops);
	}
...
void ply_describe_other_properties(PlyFile *plyfile, PlyOtherProp *other,
		int offset) {
	int i;
	PlyElement *elem;
	PlyProperty *prop;
	...
	if (elem->nprops == 0) {
		elem->props = (PlyProperty **) myalloc(
				sizeof(PlyProperty *) * other->nprops);
...
PlyOtherElems *ply_get_other_element(PlyFile *plyfile, char *elem_name,
		int elem_count) {
	int i;
	PlyElement *elem;
	...
	other->other_data = (OtherData **) malloc(
