 ...
 */
void drawTriangleSelect(GLfloat x1, GLfloat y1, GLfloat x2, GLfloat y2,
...
void drawViewVolumeSelect(GLfloat x1, GLfloat x2, GLfloat y1, GLfloat y2,
...
void drawSceneSelect(void) {
	...
	drawTriangleSelect(2.0, 2.0, 3.0, 2.0, 2.5, 3.0, -5.0);
	glColor3f(1.0, 0.0, 0.0); /*  red triangle	*/
	drawTriangleSelect(2.0, 7.0, 3.0, 7.0, 2.5, 8.0, -5.0);
	glColor3f(1.0, 1.0, 0.0); /*  yellow triangles	*/
	drawTriangleSelect(2.0, 2.0, 3.0, 2.0, 2.5, 3.0, 0.0);
	drawTriangleSelect(2.0, 2.0, 3.0, 2.0, 2.5, 3.0, -10.0);
	drawViewVolumeSelect(0.0, 5.0, 0.0, 5.0, 0.0, 10.0);
}

/* processHits prints out the contents of the selection array
 */
void processHitsSelect(GLint hits, GLuint buffer[]) {
	unsigned int i, j;
	GLuint names, *ptr;
...
void selectObjects(void) {
	...
	processHitsSelect(hits, selectBuf);
}
...
void keyboardSelect(unsigned char key, int x, int y) {
	switch (key) {
	case 27:
		exit(0);
		break;
...
int mainSelect(int argc, char** argv) {
	...
	glutKeyboardFunc(keyboardSelect);
	glutMainLoop();
	return 0;
}
