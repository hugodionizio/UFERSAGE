...
void print3DcolorVertexFeedback(GLint size, GLint *count, GLfloat *buffer) {
	int i;
...
void printBufferFeedback(GLint size, GLfloat *buffer) {
	GLint count;
	GLfloat token;
	...
	while (count) {
		...
		if (token == GL_PASS_THROUGH_TOKEN) {
			...
			print3DcolorVertexFeedback(size, &count, buffer);
