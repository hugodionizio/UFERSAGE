...
static void renderSphereFog(GLfloat x, GLfloat y, GLfloat z) {
	glPushMatrix();
	glTranslatef(x, y, z);
...
void displayFog(void) {
	...
	renderSphereFog(-2., -0.5, -1.0);
	renderSphereFog(-1., -0.5, -2.0);
	renderSphereFog(0., -0.5, -3.0);
	renderSphereFog(1., -0.5, -4.0);
	renderSphereFog(2., -0.5, -5.0);
	glFlush();
}

void reshapeFog(int w, int h) {
