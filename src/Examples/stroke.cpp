...
CP Adata[] = { { 0, 0, PT }, { 0, 9, PT }, { 1, 10, PT }, { 4, 10, PT }, { 5, 9,
		PT }, { 5, 0, STROKE }, { 0, 5, PT }, { 5, 5, END } };

CP Edata[] = { { 5, 0, PT }, { 0, 0, PT }, { 0, 10, PT }, { 5, 10, STROKE }, {
		0, 5, PT }, { 4, 5, END } };

CP Pdata[] = { { 0, 0, PT }, { 0, 10, PT }, { 4, 10, PT }, { 5, 9, PT }, { 5, 6,
		PT }, { 4, 5, PT }, { 0, 5, END } };

CP Rdata[] = { { 0, 0, PT }, { 0, 10, PT }, { 4, 10, PT }, { 5, 9, PT }, { 5, 6,
		PT }, { 4, 5, PT }, { 0, 5, STROKE }, { 3, 5, PT }, { 5, 0, END } };

CP Sdata[] = { { 0, 1, PT }, { 1, 0, PT }, { 4, 0, PT }, { 5, 1, PT }, { 5, 4,
		PT }, { 4, 5, PT }, { 1, 5, PT }, { 0, 6, PT }, { 0, 9, PT }, { 1, 10,
		PT }, { 4, 10, PT }, { 5, 9, END } };

/*  drawLetter() interprets the instructions from the array
 *  for that letter and renders the letter with line segments.
 */
static void drawLetterStroke(CP *l) {
...
static void initStroke(void) {
	...
	drawLetterStroke(Adata);
	glEndList();
	glNewList(base + 'E', GL_COMPILE);
	drawLetterStroke(Edata);
	glEndList();
	glNewList(base + 'P', GL_COMPILE);
	drawLetterStroke(Pdata);
	glEndList();
	glNewList(base + 'R', GL_COMPILE);
	drawLetterStroke(Rdata);
	glEndList();
	glNewList(base + 'S', GL_COMPILE);
	drawLetterStroke(Sdata);
	glEndList();
 ...
 */
int mainStroke(int argc, char** argv) {
	glutInit(&argc, argv);
