...
static void initStroke (void)
{
   ...
   base = glGenLists (128);
   glListBase(base);
   glNewList(base+'A', GL_COMPILE); drawLetterStroke(Adata); glEndList();
   glNewList(base+'E', GL_COMPILE); drawLetterStroke(Edata); glEndList();
   glNewList(base+'P', GL_COMPILE); drawLetterStroke(Pdata); glEndList();
   glNewList(base+'R', GL_COMPILE); drawLetterStroke(Rdata); glEndList();
   glNewList(base+'S', GL_COMPILE); drawLetterStroke(Sdata); glEndList();
