...
//create the data to put into the texture
	...
	imageVortex = (unsigned char *) malloc(sizeof(unsigned char) * size);
	int i;
	for (i = 0; i < size; i = i + 1)
		imageVortex[i] = (i / 256);  //create the texture
	...
	glBufferData(GL_PIXEL_UNPACK_BUFFER_ARB,
			sizeof(unsigned char) * imageWidth * imageHeight * 4, imageVortex,
			GL_STREAM_DRAW);
